...
export const Add = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" width="35" height="35">
...
export const Home = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="35" height="35" className="w-6 h-6">
...
export const Archive = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="35" height="35" className="w-6 h-6">
...
export const Cross = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="25" height="25" className="w-6 h-6">
...
export const GoogleInitial = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height="35" width="35" style={{ backgroundColor: '#0057ee' }}>
            <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontFamily="Helvetica, Arial, sans-serif" fontSize="20" fill="#f9f9f9">R</text>
        </svg>
    );
}
...
export const Pdf = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" strokeWidth={1} stroke="white" height="25" width="25" className="w-6 h-6">
...
export const Send = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" strokeWidth={1.5} height="25" width="25" stroke="currentColor" className="w-6 h-6">
...
export const Ellipsis = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30" className="w-6 h-6">
...
export const Timer = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6" height="18" width="18">
...
export const GoBack = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6" height="18" width="18">
