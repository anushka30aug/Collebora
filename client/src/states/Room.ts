...
export const fetchClassrooms = createAsyncThunk(
  ...
  async (isActive: boolean) => {
    ...
    const response = await fetch(
      `${host}/classroom/actions/read?isActive=${isActive}`,
      {
        method: "GET",
        headers: headers,
      }
...
export const fetchClassroomsAsAdmin = createAsyncThunk(
  "/classroom/fetchAsAdmin",
  async (isActive: boolean) => {
    const token = localStorage.getItem("auth-token-workspace");
    const headers: HeadersInit = {
      "Content-Type": "application/json",
    ...
    const response = await fetch(
      `${host}/classroom/actions/readAsAdmin?isActive=${isActive}`,
      {
        method: "GET",
        headers: headers,
      }
...
export const RenameClassroom = createAsyncThunk(
  ...
  async ({
    ...
    const response = await fetch(
      `${host}/classroom/actions/update/${classId}`,
      {
        method: "PUT",
        headers: headers,
...
export const deleteClassroom = createAsyncThunk(
  "/classroom/delete",
  async ({ classId, code }: { classId: string; code: string }) => {
    const token = localStorage.getItem("auth-token-workspace");
    const headers: HeadersInit = {
      "Content-Type": "application/json",
    };
...
export const sendInvitation = createAsyncThunk(
  "/classroom/sendInvitation",
  async ({ classId, emails }: { classId: string; emails: string[] }) => {
    const token = localStorage.getItem("auth-token-workspace");
    const headers: HeadersInit = {
      "Content-Type": "application/json",
    };
